...
const ROWS: Row[] = [
  ...
  ["glute-bridge", "Glute Bridge", "glute bridges;hip bridge;bridge;bridges", "gl,ha,co", "qu,bk", "", 0],
  ...
  ["back-extension", "Back Extension", "back extensions;hyperextension;hyperextensions;superman machine", "bk,gl,ha", "co", "mc", 0],
  ["reverse-hyper", "Reverse Hyper", "reverse hypers;reverse hyperextension", "gl,ha,bk", "co", "mc", 0],
  ...
  ["squat-clean", "Squat Clean", "squat cleans;full clean", "fb", "qu,gl,ha,bk,sh", "bb", 0],
  ["clean-and-jerk", "Clean and Jerk", "clean jerk;clean and jerks", "fb", "qu,gl,bk,sh,tr", "bb", 0],
  ...
  ["machine-chest-press", "Machine Chest Press", "chest press machine;seated chest press;chest press", "ch,tr,sh", "co", "mc", 0],
  ...
  ["rear-delt-fly", "Rear Delt Fly", "rear delt flies;reverse fly;reverse flyes;rear delt raise;rear fly;bent over rear delt fly", "sh,bk", "co", "db,cb", 0],
  ...
  ["band-pull-apart", "Band Pull Apart", "band pull aparts;pull aparts", "sh,bk", "co,fa", "rb", 0],
  ...
  // ---------- arms ----------
  ["dumbbell-curl", "Dumbbell Curl", "dumbbell curls;curl;curls;bicep curl;bicep curls;biceps curl;db curl;standing dumbbell curl", "bi,fa", "sh", "db", 0],
  ["barbell-curl", "Barbell Curl", "barbell curls;bb curl;straight bar curl", "bi,fa", "sh", "bb", 0],
  ["ez-bar-curl", "EZ Bar Curl", "ez curl;ez bar curls", "bi,fa", "sh", "bb", 0],
  ["hammer-curl", "Hammer Curl", "hammer curls;db hammer curl;neutral grip curl", "bi,fa", "sh", "db", 0],
  ...
  ["zottman-curl", "Zottman Curl", "zottman curls", "bi,fa", "sh", "db", 0],
  ["drag-curl", "Drag Curl", "drag curls", "bi", "fa,bk", "bb", 0],
  ["reverse-curl", "Reverse Curl", "reverse curls;reverse grip curl", "fa,bi", "sh", "bb,db", 0],
  ...
  ["reverse-crunch", "Reverse Crunch", "reverse crunches", "co", "qu", "", 0],
  ["cable-crunch", "Cable Crunch", "kneeling cable crunch;rope crunch", "co", "bk", "cb", 0],
  ["sit-up", "Sit-Up", "sit up;sit ups;situp;situps;full sit up", "co", "qu", "", 0],
  ["bicycle-crunch", "Bicycle Crunch", "bicycle crunches;bicycles;bicycle kicks", "co", "qu", "", 0],
  ...
  ["dead-bug", "Dead Bug", "dead bugs;deadbug", "co", "qu", "", 0],
  ...
  ["assault-bike", "Assault Bike", "air bike;echo bike;fan bike", "fb", "qu,sh,bk,co", "mc", 0],
  ...
  ["elliptical", "Elliptical", "cross trainer;elliptical machine", "fb", "qu,gl,ca,sh", "mc", 0],
  ...
  ["burpee", "Burpee", "burpees;burpee to jump", "fb", "ch,tr,qu,gl,co", "", 0],
  ["devils-press", "Devil's Press", "devils press;devil press", "fb", "sh,qu,gl,co", "db", 0],
  ["man-maker", "Man Maker", "man makers;manmaker", "fb", "sh,bk,ch,co", "db", 0],
  ...
  ["cat-cow", "Cat-Cow", "cat cow;cat camel;cat cow stretch", "bk,co", "sh", "", 0],
  ...
  ["hip-flexor-stretch", "Hip Flexor Stretch", "hip flexor stretches;couch stretch;kneeling hip flexor stretch", "qu,gl", "co", "", 1],
  ["hamstring-stretch", "Hamstring Stretch", "seated hamstring stretch;standing hamstring stretch", "ha", "ca,bk", "", 0],
  ["worlds-greatest-stretch", "World's Greatest Stretch", "worlds greatest stretch;greatest stretch;wgs", "fb", "gl,ha,co,sh", "", 1],
  ["thread-the-needle", "Thread the Needle", "thread needle;thread the needle stretch", "bk,sh", "ch", "", 1],
  ["sun-salutation", "Sun Salutation", "sun salutations;surya namaskar", "fb", "sh,ha,bk,co", "", 0],
];
