...
(function () {
  ...
  // Wherever a panel prints a weight's unit.
  // LOG wave: becomes wtUnit(ex)
  function wtUnitOf(ex) { return state.unit; }
  ...
  function stepDock(dock) {
    ...
    $("wtunit").textContent = wtUnitOf(wo.screens[dock._k].ex);
    drawStepper();
  }
