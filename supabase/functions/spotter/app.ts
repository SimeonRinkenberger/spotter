...
(function () {
  ...
  // this, so the path detects itself away and the card stands alone there.
  function liveNote(close) {
    ...
    navigator.serviceWorker.ready.then(function (reg) {
      ...
      reg.showNotification(wo.workout.title || "Workout", {
        ...
        // Silent, so a ticking rest never lights the screen. Android holds a row
        // anyway; requireInteraction is for the desktops, which fade one out.
  ...
  // and the sentence explaining it carries the way out. On Android it is also the
