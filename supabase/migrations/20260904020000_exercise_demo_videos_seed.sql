...
values
  ...
  ('chest-supported-row', '4H2ItXwUTp8', 'Seal Row', 'Renaissance Periodization', 'UCfQgsKhHjSyRLOp9mnffqVg', 'rp', 1, 15, 0, 'exact'),
...
values
  ...
  ('back-squat', '6Ai-ne7Lh6M', '1 1/4 Back Squat', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 66, 3, 'exact'),
  ...
  ('bench-dip', 'em94npR71nk', 'Bench Dip', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 41, 1, 'exact'),
  ('bench-press', 'GlPKtOUvZqw', 'Bench Press', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 50, 2, 'exact'),
  ...
  ('chest-fly', 'T3EOhuU5RQg', 'Pec Fly', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 40, 2, 'exact'),
  ...
  ('clean-and-jerk', 'jiYPejuiNck', 'Clean-Jerk', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 55, 0, 'exact'),
  ...
  ('dip', 'sg3PTIA3rXI', 'Dip', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 49, 3, 'exact'),
  ('dumbbell-bench-press', 'ieewD7N2Nuw', 'Dumbbell Press', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 36, 1, 'exact'),
  ...
  ('front-squat', '3xwcH5APTLg', '1 1/4 Front Squat', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 65, 1, 'exact'),
  ...
  ('good-morning', 'lYUB78Btcxc', 'Good Morning', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 78, 3, 'exact'),
  ('hammer-curl', 'W0xVe5jdnOU', 'Hammer Curl', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 34, 2, 'exact'),
  ('hang-clean', 'efHjodEVf9w', 'Hang Power Clean', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 82, 2, 'exact'),
  ...
  ('hollow-hold', 'x8xSTaaMmuY', 'Hollow Hold', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 34, 2, 'exact'),
  ('incline-bench-press', 'EQSPHyJ75EM', 'Incline Bench Press', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 44, 1, 'exact'),
  ...
  ('inverted-row', '-SE-yLq8kFI', 'Ring Row', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 37, 3, 'exact'),
  ...
  ('lat-pulldown', 'uAcQQ9jp2zk', 'Wide-Grip Lat Pulldown', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 38, 1, 'exact'),
  ('lateral-lunge', 'dQZjFjYyghY', 'Lateral Lunge', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 64, 2, 'exact'),
  ('lateral-raise', 'goVyitDXa5o', 'Cable Lateral Raise', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 41, 3, 'exact'),
  ...
  ('lunge', 'bBrBLS7aejI', 'Lunge', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 72, 1, 'exact'),
  ...
  ('plank', 'P3FR4GUl2QM', 'Plank', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 57, 1, 'exact'),
  ('power-clean', 'oQIaWLrB318', 'Clean', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 112, 1, 'exact'),
  ...
  ('single-leg-deadlift', 'opvwjIol9Ts', 'Single-Leg RDL', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 62, 1, 'exact'),
  ...
  ('split-jerk', 'OcL9OuAhFDM', 'Jerk from Split', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 59, 1, 'exact'),
  ('split-squat', 'L1LBRuJSOU8', 'Split Squat', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 47, 1, 'exact'),
  ('step-up', 'I9lUOenjk9U', 'Step-Up', 'Catalyst Athletics', 'UCOe24b2O8eoeHz9fwWuKRVA', 'catalyst', 2, 64, 1, 'exact'),
...
delete from public.exercise_demo_videos
 where source = 'catalyst' and (key, video_id) not in (
  ('ab-wheel-rollout','Ojf6jVWJDuU'), ('arnold-press','y2Z56aTvx_M'), ('back-extension','skXsFN8NfqU'), ('back-squat','6Ai-ne7Lh6M'), ('band-pull-apart','Xg58d9lDWME'), ('banded-walk','UX-hIEbWpCA'), ('bench-dip','em94npR71nk'), ('bench-press','GlPKtOUvZqw'), ('bent-over-row','cYVkgmPqRMw'), ('bird-dog','DBWdijCeSIM'), ('box-jump','d2z2_rRkpAo'), ('broad-jump','AOkmLTD8J24'), ('bulgarian-split-squat','DpZsCmsI0uk'), ('cable-curl','yGdzi_CciKY'), ('chest-fly','T3EOhuU5RQg'), ('chin-up','0PhzdeDENF0'), ('clamshell','wRlgcPJ-F-w'), ('clean-and-jerk','jiYPejuiNck'), ('concentration-curl','Bv1iH7mLfb4'), ('copenhagen-plank','VfjAmomtVa0'), ('cossack-squat','Qn5r1xZkC5Q'), ('crunch','aqn-hqIk4rk'), ('dead-bug','ZtwcT5g4Tb8'), ('deadlift','E9hLcC8ZrmA'), ('dip','sg3PTIA3rXI'), ('dumbbell-bench-press','ieewD7N2Nuw'), ('dumbbell-curl','plU7Ca7Fke8'), ('dumbbell-row','IOy2k0Cb6Vo'), ('ez-bar-curl','OgO6cWoezNc'), ('face-pull','UnSEJGBotEM'), ('farmers-carry','G-_FYQfur9w'), ('flutter-kick','QjEDhGkmx8Y'), ('front-raise','xPvL9xLXUbg'), ('front-squat','3xwcH5APTLg'), ('glute-bridge','1pqZI2t8XHo'), ('glute-ham-raise','1TlhdiFSJrU'), ('good-morning','lYUB78Btcxc'), ('hammer-curl','W0xVe5jdnOU'), ('hang-clean','efHjodEVf9w'), ('hanging-leg-raise','PjlPiVTtWA4'), ('high-pull','2Qv8pEnprpU'), ('hollow-hold','x8xSTaaMmuY'), ('incline-bench-press','EQSPHyJ75EM'), ('incline-dumbbell-curl','V8H4k8lquiU'), ('incline-dumbbell-press','JHFd-e2_M8E'), ('inverted-row','-SE-yLq8kFI'), ('jefferson-curl','lHybIJtacgU'), ('jump-squat','y10UT2nOFVs'), ('kettlebell-swing','mBajuiwRTSw'), ('kettlebell-windmill','xkqvxdrfav0'), ('lat-pulldown','uAcQQ9jp2zk'), ('lateral-lunge','dQZjFjYyghY'), ('lateral-raise','goVyitDXa5o'), ('leg-curl','E4aZsdi7ENs'), ('leg-raise','oeuKRVdhxXQ'), ('lunge','bBrBLS7aejI'), ('nordic-curl','HrOhaEnwDQY'), ('overhead-carry','u2zEzUeOI-o'), ('overhead-squat','m_fvfJi94D8'), ('overhead-tricep-extension','xbNm9fRoUTw'), ('pallof-press','GfTQ0RLZ7GA'), ('plank','P3FR4GUl2QM'), ('power-clean','oQIaWLrB318'), ('preacher-curl','90-t0TLEXAE'), ('pull-up','IxQDQ2jwS5Y'), ('push-jerk','Om7vLD6x8W0'), ('push-press','yklSQG1_Ovc'), ('push-up','8lruUgJ-Rww'), ('rear-delt-fly','7Vi3nikf65I'), ('reverse-crunch','P3HvB3fCD9Y'), ('reverse-curl','etJJujHLuXA'), ('reverse-hyper','ROV6iVsSJSE'), ('reverse-lunge','OiYhnVXrFwE'), ('romanian-deadlift','_U9KjljQyd0'), ('russian-twist','N-arXZs-H70'), ('scapular-pull-up','fAHEz25TRKU'), ('side-bend','vWAiW2v7fCs'), ('side-plank','JFBx8cpLRTw'), ('single-leg-deadlift','opvwjIol9Ts'), ('single-leg-glute-bridge','3FE2eZGeT1o'), ('sit-up','2o9zkR0hMB8'), ('skull-crusher','S3xRQfb4Alo'), ('snatch','1Lv1IyigIUY'), ('spider-curl','kF6UsS3ZXo0'), ('split-jerk','OcL9OuAhFDM'), ('split-squat','L1LBRuJSOU8'), ('step-up','I9lUOenjk9U'), ('stiff-leg-deadlift','QbmaRSO1sIM'), ('straight-arm-pulldown','ev7LG1QG05U'), ('superman','r7u7aofrP3g'), ('tricep-kickback','792uGH9RgfU'), ('tricep-pushdown','e0g_ZbWlWRI'), ('tuck-jump','1XYeIUTmBc8'), ('turkish-get-up','cAf9Zj1WIF0'), ('upright-row','eg2QH0YmDsc'), ('v-up','vPxaLvOsboM'), ('wall-sit','Ok3L48EhvYk'), ('wrist-curl','lA3QwdAn19Y'), ('zottman-curl','kc-LGcbozhI'));

-- crossfit (CrossFit), tier 2: 51 rows across 51 exercises.
insert into public.exercise_demo_videos
  (key, video_id, title, channel, channel_id, source, tier, secs, rank, method)
values
  ('back-squat', 'QmZAiBqPvZw', 'Back Squat', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 60, 2, 'exact'),
  ('bear-crawl', '-JcD5SOqW50', 'Bear Crawl', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 10, 0, 'exact'),
  ('bench-press', 'XSza8hVTlmM', 'Bench Press', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 39, 1, 'exact'),
  ...
  ('clean-and-jerk', 'PjY1rH4_MOA', 'Clean and Jerk', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 84, 1, 'exact'),
  ('deadlift', '8OTXZn3xQkk', 'Deadlift', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 16, 1, 'exact'),
  ('dip', 'eERwCQHZqfA', 'Bar Dip', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 46, 2, 'exact'),
  ('double-under', '-tF3hUsPZAI', 'Double-under', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 20, 0, 'exact'),
  ('dumbbell-bench-press', 'AqzDJHxynwo', 'Dumbbell Press', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 42, 2, 'exact'),
  ...
  ('front-squat', 'uYumuL_G_V0', 'Front Squat', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 66, 2, 'exact'),
  ('glute-ham-raise', 'm0AIU1dCVkU', 'Glute-Ham Raise', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 24, 1, 'exact'),
  ('good-morning', 'KxYxHr1lkx4', 'Good Morning', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 52, 1, 'exact'),
  ('handstand-push-up', '0wDEO6shVjc', 'Strict Handstand Push-Up', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 49, 0, 'confirmed'),
  ('hang-clean', '0aP3tgKZcHQ', 'Hang Power Clean', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 59, 1, 'exact'),
  ('hollow-hold', 'p7j02V1fIzU', 'Hollow Rock', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 31, 1, 'exact'),
  ('inverted-row', 'xhlReCpAE9k', 'Ring Row', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 35, 2, 'exact'),
  ...
  ('plank', 'sZxrs3C209k', 'Plank Hold', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 18, 0, 'exact'),
  ...
  ('snatch', 'TL8SMp7RdXQ', 'Power Snatch', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 68, 0, 'exact'),
  ('split-jerk', 'PsiO8lZTU2I', 'Split Jerk', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 55, 0, 'exact'),
  ('step-up', '5qjqDHOUh-A', 'Box Step-Up', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 56, 0, 'exact'),
  ...
  ('thruster', 'M5gEwLTtWbg', 'Dumbbell Thruster', 'CrossFit', 'UCtcQ6TPwXAYgZ1Mcl3M1vng', 'crossfit', 2, 49, 0, 'exact'),
...
delete from public.exercise_demo_videos
 where source = 'crossfit' and (key, video_id) not in (
  ('back-squat','QmZAiBqPvZw'), ('bear-crawl','-JcD5SOqW50'), ('bench-press','XSza8hVTlmM'), ('bodyweight-squat','rMvwVtlqjTE'), ('box-jump','52r_Ul5k03g'), ('burpee','u4lvmtFqgio'), ('clean-and-jerk','PjY1rH4_MOA'), ('deadlift','8OTXZn3xQkk'), ('dip','eERwCQHZqfA'), ('double-under','-tF3hUsPZAI'), ('dumbbell-bench-press','AqzDJHxynwo'), ('dumbbell-floor-press','6G-fNatzuSk'), ('dumbbell-row','u63l9f0dAHU'), ('dumbbell-shoulder-press','5yWaNOvgFCM'), ('farmers-carry','p5MNNosenJc'), ('front-squat','uYumuL_G_V0'), ('glute-ham-raise','m0AIU1dCVkU'), ('good-morning','KxYxHr1lkx4'), ('handstand-push-up','0wDEO6shVjc'), ('hang-clean','0aP3tgKZcHQ'), ('hollow-hold','p7j02V1fIzU'), ('inverted-row','xhlReCpAE9k'), ('kettlebell-snatch','ZQccQg4kDf8'), ('kettlebell-swing','vdezTMulJ-k'), ('l-sit','DemH-mw1O9I'), ('medicine-ball-slam','ePo39a3mSfk'), ('muscle-up','o69WaY_7k2c'), ('overhead-squat','pn8mqlG0nkE'), ('pistol-squat','keSzg7MaoVQ'), ('plank','sZxrs3C209k'), ('power-clean','GVt4uQ0sDJE'), ('pull-over','faJDYEZmueM'), ('pull-up','aAggnpPyR6E'), ('push-jerk','VrHNJXoSyXw'), ('push-press','iaBVSJm78ko'), ('push-up','_l3ySVKYVJ8'), ('ring-dip','Vt0lO4jpIDo'), ('snatch','TL8SMp7RdXQ'), ('split-jerk','PsiO8lZTU2I'), ('step-up','5qjqDHOUh-A'), ('sumo-deadlift','wQHSYDSgDn8'), ('sumo-deadlift-high-pull','gh55vVlwlQg'), ('thruster','M5gEwLTtWbg'), ('toes-to-bar','xX9Hzi7Onnw'), ('turkish-get-up','-_zTytmHM94'), ('v-up','Mk4zCq9b6hU'), ('walking-lunge','L8fvypPrzzs'), ('wall-ball','fpUD0mcFp_0'), ('wall-walk','2TnX8j29tRY'), ('windshield-wiper','W2xdEDuR-dE'), ('zercher-squat','nwx6Ip7hd3I'));

-- tnation (T-Nation), tier 2: 28 rows across 28 exercises.
insert into public.exercise_demo_videos
  (key, video_id, title, channel, channel_id, source, tier, secs, rank, method)
values
  ('bent-over-row', 'xz1ep9Oaq3s', 'Pendlay Row', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 38, 2, 'exact'),
  ('calf-raise', 'bRwuofCC9Sg', 'Standing Calf Raise', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 24, 1, 'exact'),
  ...
  ('good-morning', 'bmZwXcpXHyA', 'Good Morning', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 52, 2, 'exact'),
  ('hang-clean', '0OTMSpN88jY', 'Power Clean from Hang', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 55, 0, 'exact'),
  ...
  ('lateral-raise', '8mj7_p9F6W0', 'Dumbbell Lateral Raise', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 28, 2, 'exact'),
  ...
  ('seated-calf-raise', 'vWuPAgSSmiA', 'Seated Calf Raise', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 28, 1, 'exact'),
  ...
  ('step-up', 'bc61ZPAnY8o', 'Step Up', 'T-Nation', 'UC6TRaqsCQQBI0QF6aSBz4nw', 'tnation', 2, 90, 2, 'exact'),
...
values
  ...
  ('back-squat', 'mqP6RKUMwD0', 'Squat', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 25, 1, 'exact'),
  ('barbell-curl', 'htvWPy1umbE', 'Barbell Curl', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 20, 1, 'exact'),
  ('bench-dip', 'qLeMTzWS-TQ', 'Bench Dips', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 11, 0, 'exact'),
  ('bench-press', '4uSFvPyZI7I', 'Barbell Bench Press', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 17, 0, 'exact'),
  ...
  ('calf-raise', 'RLwzCkxgnVY', 'Calve Raises', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 11, 0, 'exact'),
  ('chest-fly', 'KIxb2_1ycmo', 'Dumbbell Flys', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 21, 1, 'exact'),
  ...
  ('dip', 't7iKeDfccxU', 'Dips', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 15, 1, 'exact'),
  ('donkey-kick', 'hAURyHg_bSo', 'Donkey Kicks', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 12, 1, 'exact'),
  ('dumbbell-bench-press', 'fRoZhQLpnGs', 'Dumbbell Bench Press', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 43, 3, 'exact'),
  ...
  ('good-morning', '7JB8TJVWIkY', 'Good Mornings', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 17, 0, 'exact'),
  ('hammer-curl', 'lKK-ob3f8Qc', 'Hammer Curls', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 19, 1, 'exact'),
  ...
  ('incline-bench-press', '_aJHyS_JAaY', 'Incline Barbell Bench Press', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 31, 0, 'exact'),
  ...
  ('lateral-lunge', 'IiJtyFrlwxk', 'Lateral Lunges', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 11, 1, 'exact'),
  ('lateral-raise', 'WAoUNUkni9Y', 'Side Lateral Raises', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 21, 1, 'exact'),
  ...
  ('lunge', 'zYQmub9i7ts', 'Lunges', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 9, 0, 'exact'),
  ...
  ('seated-calf-raise', 'SilwFPMr5SY', 'Seated Calf Raises', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 23, 0, 'exact'),
  ...
  ('single-leg-deadlift', 'jebj_GQS474', '1 Leg Romanian Deadlifts', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 21, 0, 'exact'),
  ('single-leg-glute-bridge', 'DHGKTrJUXy4', 'Single Leg Glute Bridge', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 34, 1, 'exact'),
  ('stiff-leg-deadlift', 'gSRvFyzg8To', 'Stiff Leg Deadlifts', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 25, 1, 'exact'),
