...
-- neutral words left over 57, owner-confirmed in tools/demo-videos-review.json 57,
...
-- rp (Renaissance Periodization), tier 1: 65 rows across 65 exercises.
...
values
  ...
  ('bench-press', 'gMgvBspQ9lk', 'Medium Grip Bench Press', 'Renaissance Periodization', 'UCfQgsKhHjSyRLOp9mnffqVg', 'rp', 1, 13, 0, 'exact'),
...
values
  ...
  ('bench-press', '4uSFvPyZI7I', 'Barbell Bench Press', 'MuscleWiki', 'UCFpj07BSepA04QgvKSUX8eg', 'musclewiki', 2, 17, 3, 'exact'),
...
-- bbcom (Bodybuilding.com), tier 3: 51 rows across 51 exercises.
insert into public.exercise_demo_videos
  (key, video_id, title, channel, channel_id, source, tier, secs, rank, method)
values
